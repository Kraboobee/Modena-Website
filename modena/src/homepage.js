...
const softwareDefault = {
        ...
        logo:       NoImage, 
        alias:      '',
        ram:        `The amount of memory you will need depends on how many programs you will have open at any given time alongside ${this.alias} and how large the files are that you will be working with. A good starting point in deciding how much RAM you should go for would be to check your current usage via Windows Task Manager.`, 
